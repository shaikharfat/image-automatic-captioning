...
if __name__ == '__main__':
    ...
    dir_Flickr_text = r"C:\Users\Xpro\autocaption\Flickr8k_text\Flickr8k.token.txt"
    ...
    for i, caption in enumerate(df_txt.caption.values):
        ...
        #print(df_txt["caption"].iloc[i])
        #print(len(df_txt.caption))
        #40460
    ...
    df_txt0.to_csv('C:/Users/Xpro/autocaption/data/token0.txt', sep='\t', index=False)
    df_txt0_new = pd.read_csv('C:/Users/Xpro/autocaption/data/token0.txt', sep='\t')
